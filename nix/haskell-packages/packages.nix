...
self: {
  ...
  "case-insensitive" = callPackage
    ({ mkDerivation, base, bytestring, deepseq, hashable, text }:
     mkDerivation {
  ...
  "conduit" = callPackage
    ({ mkDerivation, base, containers, exceptions, hspec, lifted-base
     , mmorph, monad-control, mtl, primitive, QuickCheck, resourcet
     , safe, split, transformers, transformers-base, transformers-compat
     }:
     mkDerivation {
       pname = "conduit";
       version = "1.2.12.1";
  ...
  "foldl" = callPackage
    ({ mkDerivation, base, bytestring, comonad, containers
     , contravariant, hashable, mwc-random, primitive, profunctors, text
  ...
  "foundation" = callPackage
    ({ mkDerivation, base, basement, ghc-prim }:
     mkDerivation {
       pname = "foundation";
       version = "0.0.17";
  ...
  "http-client-tls" = callPackage
    ({ mkDerivation, base, bytestring, case-insensitive, connection
     , containers, cryptonite, data-default-class, exceptions, hspec
     , http-client, http-types, memory, network, network-uri, text, tls
     , transformers
     }:
     mkDerivation {
  ...
  "lens" = callPackage
    ({ mkDerivation, array, base, base-orphans, bifunctors, bytestring
     ...
     , contravariant, deepseq, directory, distributive, doctest
  ...
  "scientific" = callPackage
    ({ mkDerivation, base, binary, bytestring, containers, deepseq
     , hashable, integer-gmp, integer-logarithms, primitive, QuickCheck
